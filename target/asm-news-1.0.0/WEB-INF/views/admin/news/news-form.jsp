        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <div class="col-md-9 col-lg-10 ms-auto main-content">
                            ...
                            <div class="container-fluid p-4">
                                <form id="newsForm" action="${pageContext.request.contextPath}/admin/news/save"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="checkbox" id="home"
                                                            name="home" ${news.home ? 'checked' : '' }>
                                                        <label class="form-check-label" for="home">Hiển thị nổi bật
                                                            trang chủ</label>
                                                    </div>
                                                </div>
                                            </div>
